...
console.log("app.js : loading start");
...
*/	
	...
	function (angular, routeConfig) {
		console.log("app.js / define() : start");
		...
		//모듈 선언
		var module = angular.module('myApp', [], function ($provide, $compileProvider, $controllerProvider, $filterProvider) {
			console.log("app.js / define() / define module : \'myApp\'");
		...
		module.controller('CommonController', function($scope) {
		
			console.log("app.js / define() / myApp.controller : CommonController");
			//스타일시트 업데이트
			 $scope.$on('updateCSS', function(event, args) {
				 console.log("app.js / define() / CommonController / updateCSS");
				//파라메터로 받아온 스타일 시트 반영
		...
		console.log("app.js / define() : end");
 	}
);
console.log("app.js : loading end");